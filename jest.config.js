module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|react-native-.*|@expo/.*|expo-.*|@unimodules/.*|unimodules-.*|sentry-expo|native-base|react-navigation|@react-navigation/.*|@expo-google-fonts/.*|expo|react-native-view-shot)/)',
  ],
  ...
  moduleNameMapper: {
    ...
    '^expo-auth-session/providers/google$': '<rootDir>/__mocks__/expo-auth-session__providers__google.js',
