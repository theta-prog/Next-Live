...
describe('Database', () => {
  ...
  describe('Artists', () => {
    it('should create an artist', async () => {
      ...
      // Mock: getStoredData for existing artists, getNextId counter call
      mockAsyncStorage.getItem
        .mockResolvedValueOnce('[]') // existing artists
        .mockResolvedValueOnce('0'); // counter
  ...
  describe('Live Events', () => {
    it('should create a live event', async () => {
      ...
      // Mock: getStoredData for existing events, getNextId counter call
      mockAsyncStorage.getItem
  ...
  describe('Memories', () => {
    it('should create a memory', async () => {
      ...
      // Mock: getStoredData for existing memories, getNextId counter call
      mockAsyncStorage.getItem
  ...
  describe('Data Updates', () => {
    it('should update artist name', async () => {
      ...
      await database.updateArtist(1, { name: 'New Name' });
